    ...
    if delivery_runner_metrics:
        try:
            ...
            delivery_json = {
                ...
                'order_penetration_rate': delivery_runner_metrics.order_penetration_rate,
                'average_order_value': delivery_runner_metrics.average_order_value,
                'orders_per_runner_hour': delivery_runner_metrics.orders_per_runner_hour,
                'on_time_rate': delivery_runner_metrics.on_time_rate,
                'delivery_cycle_time_p50': delivery_runner_metrics.delivery_cycle_time_p50,
                'delivery_cycle_time_p90': delivery_runner_metrics.delivery_cycle_time_p90,
                'dispatch_delay_avg': delivery_runner_metrics.dispatch_delay_avg,
                'travel_time_avg': delivery_runner_metrics.travel_time_avg,
                ...
                'runner_utilization_handoff_pct': delivery_runner_metrics.runner_utilization_handoff_pct,
                'runner_utilization_deadhead_pct': delivery_runner_metrics.runner_utilization_deadhead_pct,
                'distance_per_delivery_avg': delivery_runner_metrics.distance_per_delivery_avg,
                'queue_depth_avg': delivery_runner_metrics.queue_depth_avg,
                'queue_wait_avg': delivery_runner_metrics.queue_wait_avg,
                'capacity_15min_window': delivery_runner_metrics.capacity_15min_window,
