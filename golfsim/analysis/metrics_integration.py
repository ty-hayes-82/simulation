    ...
    if delivery_runner_metrics:
        try:
            ...
            delivery_json = {
                ...
                'runner_utilization_prep_pct': delivery_runner_metrics.runner_utilization_prep_pct,
                'runner_utilization_idle_pct': delivery_runner_metrics.runner_utilization_idle_pct,
                ...
                'pending_orders': delivery_runner_metrics.pending_orders,
